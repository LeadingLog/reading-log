...
export default function TimeLine() {
  ...
  return (
    <section className="flex flex-col gap-4 rounded-xl">
      <article className="flex justify-center items-center text-allReadingTimeText text-2xl bg-allReadingTimeBg rounded-xl p-3.5">
      ...
      <article className="flex justify-center items-center gap-16 border-borderColor_2 border-4 rounded-xl p-2">
        ...
        <span className="text-2xl text-yearSlideThisYearText font-bold">2025</span>
