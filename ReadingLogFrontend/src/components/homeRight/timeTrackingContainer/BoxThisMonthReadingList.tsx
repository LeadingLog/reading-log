  ...
  return (
    ...
    <>
      ...
      {thisMonthReadingList.length === 0 ? (
        ...
        <li
          key={item.bookId}
          className={`active:scale-[98%] cursor-pointer gap-2 flex justify-between hover:bg-readingList_Hover transition-[background, scale] duration-100 p-3 rounded-xl bg-readingList_Bg group
