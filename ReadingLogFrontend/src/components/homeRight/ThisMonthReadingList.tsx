    ...
    <section className="flex flex-col gap-5">
      ...
      <ul className="flex flex-col gap-3">
        <li className="flex justify-between p-3.5 rounded-xl bg-readingListBg">
          ...
          <div className="relative flex w-[70px] justify-end items-center bg-toggleBg rounded-full">
        ...
        <li className="flex justify-between p-3.5 rounded-xl bg-readingListBg">
          <span className="text-xl">책이름</span>
          <div className="relative flex justify-end items-center bg-noReadingBg py-0.5 px-2 rounded-full">
            <span className="text-xs text-noReadingBg contrast-0">읽기전</span>
          </div>
        </li>
        <li className="flex justify-between p-3.5 rounded-xl bg-readingListBg">
          <span className="text-xl">책이름</span>
          <div className="relative flex w-[70px] justify-start items-center bg-toggleBg rounded-full">
