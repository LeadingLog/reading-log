  ...
  theme     : {
    extend: {
      colors: {
        ...
        imgBook_Item_ReadingStart_Text_Color: "#ffffff", // 이미지로 표시하는 책 리스트 내부 아이콘 - 타이머 or 스탑워치 실행중인 도서인 경우 텍스트 색
        ...
        modal_Tracking_Reverse_loadingBg          : "#ffffff",   // 독서 타임 트래킹 - reverseBtn : true 시 로딩 중일 때 배경 색
        ...
        /* 독서 상태 토글 관련 색 */
        toggle_ReadingStart_Text_Color: "#ffffff", // 독서 상태 토글 - 토글이 독서중인 경우 텍스트 색
        ...
        /* 툴팁 관련 */
        tooltip_bg               : "#FDFAF3", // 툴팁 배경 색
        tooltip_border_Reading   : "#C9A89F", // 툴팁 독서중 보더 색
        tooltip_border_Complete  : "#96B2C8", // 툴팁 완독 보더 색
        tooltip_border_No_Reading: "#D9D9D9", // 툴팁 읽기전 보더 색
